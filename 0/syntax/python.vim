" Vim syntax file
" Language:             Python(both 2 and 3)
" Last Change:          2015-08-03
" Filenames:            *.py
" Version:              1.1
"
" Based on python-syntax: https://github.com/hdima/python-syntax
"
" Options
" =======
"
...
" -------------------------------
"
"    python_version_2                       Can also be set as a buffer 
"                                           (b:python_version_2) variable.
"
...
" For python 'self'
"
syn keyword pythonSelfPara     self
...
syn match   pythonClass         "[a-zA-Z_][a-zA-Z0-9]*" display contained
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonSelfPara         pythonSelfPara
